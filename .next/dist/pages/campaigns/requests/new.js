...
var RequestNew = function (_Component) {
  ...
  (0, _createClass3.default)(RequestNew, [{
    ...
    value: function render() {
      ...
      })), _react2.default.createElement(_semanticUiReact.Message, { error: true, header: "Oops!", content: this.state.errMessage }), _react2.default.createElement(_semanticUiReact.Button, { loading: this.state.loading, primary: true }, "Create!")));
    }
  }], [{
    key: "getInitialProps",
    value: function () {
